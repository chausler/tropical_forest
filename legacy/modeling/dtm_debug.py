...
class DtmModel(utils.SaveLoad):
    ...
    def train(self, corpus, time_slices, mode='fit', model='dtm'):
        """
        ...
        print "training DTM with args %s" % arguments
        try:
        ...
        # print self.fout_gamma() 
        # print self.gamma_
        # print self.gamma_.shape
        # print self.lencorpus
        # print self.num_topics
        
        # cast to correct shape, gamme[5,10] is the proprtion of the 10th topic in doc 5
